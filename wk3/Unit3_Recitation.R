...
library(mice) #this is pkg used for multiple imputation
...
sign(20) #sign takes a numeric element or vector 
#as input and returns 1 for elements that
#are positive, -1 for elements that are negative,
#and 0 for elements that are 0
