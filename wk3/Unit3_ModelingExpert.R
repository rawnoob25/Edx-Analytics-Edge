...
# Prediction function
ROCRpred = prediction(predictTrain, qualityTrain$PoorCare) #first parameter to prediction
# function is vector of predicted labels and second parameter is vector of true labels;
# the prediction function returns a 'prediction object'

# Performance function
ROCRperf = performance(ROCRpred, "tpr", "fpr")  #'tpr' is true positive rate
...
#Note above:text.adj adjusts the location of the labels
